...
var listaPokeFB : List<PokemonFB> = listOf(
    ...
    PokemonFB(430,"4",R.drawable.honchkrow, "Honchkrow","Si uno lanza un grito profundo, los demás acuden. Por eso se le llama también invocador de la noche.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.VOLADOR)),
    PokemonFB(431,"4",R.drawable.glameow, "Glameow","Oculta una tendencia rencorosa que le hace arañar la nariz de su entrenador si no le da de comer.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(432,"4",R.drawable.purugly, "Purugly","Rodea su cuerpo con las colas para parecer más grande. Si fija la mirada, no se perderá un detalle.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(433,"4",R.drawable.chingling, "Chingling","Emite chillidos en unas frecuencias imperceptibles para las personas. Cuando empieza no puede parar.",listOf(PokemonTipoFB.PSIQUICO)),
    ...
    PokemonFB(501,"5",R.drawable.oshawott, "Oshawott","Ataca con la vieira de su ombligo. En cuanto para un ataque, pasa al contraataque sin dilación.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(502,"5",R.drawable.dewott, "Dewott","Tras un exhaustivo entrenamiento, Dewott puede dominar diversas técnicas para usar con sus vieiras.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(503,"5",R.drawable.samurott, "Samurott","En un abrir y cerrar de ojos, puede desenvainar y envainar los sables que hay en sus patas delanteras.",listOf(PokemonTipoFB.AGUA)),
