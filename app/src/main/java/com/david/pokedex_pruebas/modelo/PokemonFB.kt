...
val evosMega: Map<String, PokemonFB> = listOf(
    ...
    PokemonFB(6,"",R.drawable.megacharizardy,"Mega-Charizard Y","", listOf(PokemonTipoFB.FUEGO, PokemonTipoFB.DRAGON), listOf()),
    PokemonFB(9,"",R.drawable.megablastoise,"Mega-Blastoise","", listOf(PokemonTipoFB.AGUA), listOf()),
    PokemonFB(15,"",R.drawable.megabeedrill,"Mega-Beedril","", listOf(PokemonTipoFB.BICHO, PokemonTipoFB.VENENO), listOf()),
    PokemonFB(18,"",R.drawable.megapidgeot,"Mega-Pidgeot","", listOf(PokemonTipoFB.NORMAL, PokemonTipoFB.VOLADOR), listOf()),
    PokemonFB(65,"",R.drawable.megaalakazam,"Mega-Alakazam","", listOf(PokemonTipoFB.PSIQUICO), listOf()),
    PokemonFB(80,"",R.drawable.megaslowbro,"Mega-Slowbro","", listOf(PokemonTipoFB.AGUA, PokemonTipoFB.PSIQUICO), listOf()),
    PokemonFB(94,"",R.drawable.megagengar,"Mega-Gengar","", listOf(PokemonTipoFB.FANTASMA, PokemonTipoFB.VENENO), listOf()),
    PokemonFB(115,"",R.drawable.megakangaskhan,"Mega-Kangaskhan","", listOf(PokemonTipoFB.NORMAL), listOf()),
    PokemonFB(127,"",R.drawable.megapinsir,"Mega-Pinsir","", listOf(PokemonTipoFB.BICHO, PokemonTipoFB.VOLADOR), listOf()),
    PokemonFB(130,"",R.drawable.megagyarados,"Mega-Gyarados","", listOf(PokemonTipoFB.AGUA, PokemonTipoFB.SINIESTRO), listOf()),
    PokemonFB(142,"",R.drawable.megaaerodactyl,"Mega-Aerodactyl","", listOf(PokemonTipoFB.ROCA, PokemonTipoFB.VOLADOR), listOf()),
    PokemonFB(150,"",R.drawable.megamewtwox,"Mega-Mewtwo X","", listOf(PokemonTipoFB.PSIQUICO, PokemonTipoFB.LUCHA), listOf()),
    PokemonFB(150,"",R.drawable.megamewtwoy,"Mega-Mewtwo Y","", listOf(PokemonTipoFB.PSIQUICO), listOf()),
    PokemonFB(181,"",R.drawable.megaampharos,"Mega-Ampharos","", listOf(PokemonTipoFB.ELECTRICO, PokemonTipoFB.DRAGON), listOf()),
    PokemonFB(208,"",R.drawable.megasteelix,"Mega-Steelix","", listOf(PokemonTipoFB.ACERO, PokemonTipoFB.TIERRA), listOf()),
    PokemonFB(212,"",R.drawable.megascizor,"Mega-Scizor","", listOf(PokemonTipoFB.BICHO, PokemonTipoFB.ACERO), listOf()),
    PokemonFB(214,"",R.drawable.megaheracross,"Mega-Heracross","", listOf(PokemonTipoFB.BICHO, PokemonTipoFB.LUCHA), listOf()),
    PokemonFB(229,"",R.drawable.megahoundoom,"Mega-Houndoom","", listOf(PokemonTipoFB.SINIESTRO, PokemonTipoFB.FUEGO), listOf()),
    PokemonFB(248,"",R.drawable.megatyranitar,"Mega-Tyranitar","", listOf(PokemonTipoFB.ROCA, PokemonTipoFB.SINIESTRO), listOf()),
    PokemonFB(254,"",R.drawable.megasceptile,"Mega-Sceptile","", listOf(PokemonTipoFB.PLANTA, PokemonTipoFB.DRAGON), listOf()),
    PokemonFB(257,"",R.drawable.megablaziken,"Mega-Blaziken","", listOf(PokemonTipoFB.FUEGO, PokemonTipoFB.LUCHA), listOf()),
    PokemonFB(260,"",R.drawable.megaswampert,"Mega-Swampert","", listOf(PokemonTipoFB.AGUA, PokemonTipoFB.TIERRA), listOf()),
    PokemonFB(282,"",R.drawable.megagardevoir,"Mega-Gardevoir","", listOf(PokemonTipoFB.PSIQUICO, PokemonTipoFB.HADA), listOf()),
    PokemonFB(302,"",R.drawable.megasableye,"Mega-Sableye","", listOf(PokemonTipoFB.SINIESTRO, PokemonTipoFB.FANTASMA), listOf()),
    PokemonFB(303,"",R.drawable.megamawile,"Mega-Mawile","", listOf(PokemonTipoFB.ACERO, PokemonTipoFB.HADA), listOf()),
    PokemonFB(306,"",R.drawable.megaaggron,"Mega-Aggron","", listOf(PokemonTipoFB.ACERO), listOf()),
    PokemonFB(308,"",R.drawable.megamedicham,"Mega-Medicham","", listOf(PokemonTipoFB.LUCHA, PokemonTipoFB.PSIQUICO), listOf()),
    PokemonFB(310,"",R.drawable.megamanectric,"Mega-Manectric","", listOf(PokemonTipoFB.ELECTRICO), listOf()),
    PokemonFB(319,"",R.drawable.megasharpedo,"Mega-Sharpedo","", listOf(PokemonTipoFB.AGUA, PokemonTipoFB.SINIESTRO), listOf()),
    PokemonFB(323,"",R.drawable.megacamerupt,"Mega-Camerupt","", listOf(PokemonTipoFB.FUEGO, PokemonTipoFB.TIERRA), listOf()),
    PokemonFB(334,"",R.drawable.megaaltaria,"Mega-Altaria","", listOf(PokemonTipoFB.DRAGON, PokemonTipoFB.HADA), listOf()),
    PokemonFB(354,"",R.drawable.megabanette,"Mega-Banette","", listOf(PokemonTipoFB.FANTASMA), listOf()),
    PokemonFB(359,"",R.drawable.megaabsol,"Mega-Absol","", listOf(PokemonTipoFB.SINIESTRO), listOf()),
    PokemonFB(362,"",R.drawable.megaglalie,"Mega-Glalie","", listOf(PokemonTipoFB.HIELO), listOf()),
    PokemonFB(373,"",R.drawable.megasalamence,"Mega-Salamence","", listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.VOLADOR), listOf()),
    PokemonFB(376,"",R.drawable.megametagross,"Mega-Metagross","", listOf(PokemonTipoFB.ACERO,PokemonTipoFB.PSIQUICO), listOf()),
    PokemonFB(380,"",R.drawable.megalatias,"Mega-Latias","", listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.PSIQUICO), listOf()),
    PokemonFB(381,"",R.drawable.megalatios,"Mega-Latios","", listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.PSIQUICO), listOf()),
    PokemonFB(384,"",R.drawable.megarayquaza,"Mega-Rayquaza","", listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.VOLADOR), listOf()),
    PokemonFB(428,"",R.drawable.megalopunny,"Mega-Lopunny","", listOf(PokemonTipoFB.NORMAL,PokemonTipoFB.LUCHA), listOf()),
    PokemonFB(445,"",R.drawable.megagarchomp,"Mega-Garchomp","", listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.TIERRA), listOf()),
    PokemonFB(445,"",R.drawable.megalucario,"Mega-Lucario","", listOf(PokemonTipoFB.LUCHA,PokemonTipoFB.ACERO), listOf()),
    PokemonFB(460,"",R.drawable.megaabomasnow,"Mega-Abomasnow","", listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.HIELO), listOf()),
    PokemonFB(475,"",R.drawable.megagallade,"Mega-Gallade","", listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.LUCHA), listOf()),
    PokemonFB(531,"",R.drawable.megaaudino,"Mega-Audino","", listOf(PokemonTipoFB.NORMAL,PokemonTipoFB.HADA), listOf()),
    PokemonFB(719,"",R.drawable.megadiancie,"Mega-Diancie","", listOf(PokemonTipoFB.ROCA,PokemonTipoFB.HADA), listOf()),
).associateBy { it.name }
