...
var listaPokeFB : List<PokemonFB> = listOf(
    ...
    PokemonFB(810,"8",R.drawable.grookey, "Grookey","Al marcar el ritmo con su baqueta especial, produce unas ondas sonoras capaces de devolver la vitalidad a la flora.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(811,"8",R.drawable.thwackey, "Thwackey","Los Thwackey que marcan el ritmo más contundente con sus dos baquetas son los más respetados por sus congéneres.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(812,"8",R.drawable.rillaboom, "Rillaboom","Controla los poderes y las raíces de su singular tocón en combate golpeándolo como si fuera un tambor.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(813,"8",R.drawable.scorbunny, "Scorbunny","Se pone a correr para elevar su temperatura corporal y propagar la energía ígnea por todo el cuerpo. Desata así su verdadera fuerza.",listOf(PokemonTipoFB.FUEGO)),
    PokemonFB(814,"8",R.drawable.raboot, "Raboot","Su suave pelaje lo protege del frío y le permite incrementar todavía más la temperatura de sus movimientos de tipo Fuego.",listOf(PokemonTipoFB.FUEGO)),
    PokemonFB(815,"8",R.drawable.cinderace, "Cinderace","Convierte piedras en balones de fuego dándoles toques y, luego, chuta con fuerza hacia el rival para chamuscarlo.",listOf(PokemonTipoFB.FUEGO)),
    PokemonFB(816,"8",R.drawable.sobble, "Sobble","Cuando se espanta, libera unas lágrimas con un factor lacrimógeno equivalente a 100 cebollas para hacer llorar también al rival.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(817,"8",R.drawable.drizzile, "Drizzile","Crea bolas de agua con el líquido que segrega por las palmas de las manos y las usa en combate de forma estratégica.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(818,"8",R.drawable.inteleon, "Inteleon","Esconde algunos trucos bajo la manga: puede disparar agua por los dedos o planear con las membranas de su espalda.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(819,"8",R.drawable.skwovet, "Skwovet","Este Pokémon se encuentra por todo Galar. No se queda tranquilo hasta que tiene ambos carrillos atiborrados de bayas.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(820,"8",R.drawable.greedent, "Greedent","Se obceca tanto en acumular bayas en la cola que no se da ni cuenta de cuando tiene demasiadas y se le acaban cayendo.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(821,"8",R.drawable.rookidee, "Rookidee","De naturaleza valiente, planta cara a cualquier rival, por muy fuerte que sea. Los contraataques que recibe le sirven para fortalecerse.",listOf(PokemonTipoFB.VOLADOR)),
    PokemonFB(822,"8",R.drawable.corvisquire, "Corvisquire","Su inteligencia le permite servirse de objetos. Por ejemplo, recoge y lanza piedras con las patas, o utiliza cuerdas para atrapar a su oponente.",listOf(PokemonTipoFB.VOLADOR)),
    PokemonFB(823,"8",R.drawable.corviknight, "Corviknight","No tiene rival en los cielos de Galar. El acero negro y lustroso de su cuerpo intimida a cualquier adversario.",listOf(PokemonTipoFB.VOLADOR,PokemonTipoFB.ACERO)),
    PokemonFB(824,"8",R.drawable.blipbug, "Greedent","Siempre está recopilando información, por lo que es muy inteligente, aunque su fuerza deja bastante que desear.",listOf(PokemonTipoFB.BICHO)),
    PokemonFB(825,"8",R.drawable.dottler, "Greedent","Apenas se mueve, pero está vivo. Se cree que adquiere poderes psíquicos mientras permanece recluido en su caparazón sin comer ni beber.",listOf(PokemonTipoFB.BICHO,PokemonTipoFB.PSIQUICO)),
    PokemonFB(826,"8",R.drawable.orbeetle, "Greedent","Este Pokémon es conocido por su inteligencia. El gran tamaño de su cerebro es un indicio de la magnitud de sus poderes psíquicos.",listOf(PokemonTipoFB.BICHO,PokemonTipoFB.PSIQUICO)),
    PokemonFB(827,"8",R.drawable.nickit, "Nickit","Prudente y astuto, borra con la cola las huellas que deja al huir tras robarle el alimento a otro Pokémon.",listOf(PokemonTipoFB.SINIESTRO)),
    PokemonFB(828,"8",R.drawable.thievul, "Thievul","Marca a su presa sin ser advertido. Sigue el olor y, cuando el otro Pokémon baja la guardia, aprovecha para robarle.",listOf(PokemonTipoFB.SINIESTRO)),
    PokemonFB(829,"8",R.drawable.gossifleur, "Gossifleur","Si planta su única extremidad inferior en la tierra y se expone a abundante luz solar, sus pétalos cobran un color vivo.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(830,"8",R.drawable.eldegoss, "Eldegoss","El hilo fabricado a partir de su algodón es muy bello y brillante; uno de los productos estrella de la región de Galar.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(831,"8",R.drawable.wooloo, "Wooloo","Su lana rizada es tan acolchada que no se hace daño ni aunque se caiga por un precipicio.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(832,"8",R.drawable.dubwool, "Dubwool","Sus espléndidos cuernos sirven de reclamo para atraer al sexo opuesto. No los utiliza como arma.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(833,"8",R.drawable.chewtle, "Chewtle","Muerde todo lo que se le ponga por delante. Al parecer, lo hace para aliviar el dolor que siente cuando le crecen los incisivos.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(834,"8",R.drawable.drednaw, "Drednaw","Un Pokémon de temperamento feroz que atenaza a su presa con sus fuertes mandíbulas, capaces de destrozar una barra de hierro.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.ROCA)),
    PokemonFB(835,"8",R.drawable.yamper, "Yamper","Al correr, genera electricidad por la base de la cola. Es muy popular entre los pastores de Galar.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(836,"8",R.drawable.boltund, "Boltund","La electricidad que genera y envía a sus patas le ayuda a desplazarse rápidamente. Puede correr sin descanso durante tres días y tres noches.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(837,"8",R.drawable.rolycoly, "Rolycoly","Las partes envejecidas de la corteza que se le desprenden se utilizan como combustible en lugar del carbón.",listOf(PokemonTipoFB.ROCA)),
    PokemonFB(838,"8",R.drawable.carkol, "Carkol","Gira las patas a gran velocidad para correr a unos 30 km/h. Emite llamas a una temperatura de 1000 °C.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.FUEGO)),
    PokemonFB(839,"8",R.drawable.coalossal, "Coalossal","Cuando se enzarza en un combate, la montaña de carbón arde al rojo vivo y esparce chispas que calcinan todo lo que le rodea.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.FUEGO)),
    PokemonFB(840,"8",R.drawable.applin, "Applin","Vive dentro de una manzana. Si se separa de ella, su cuerpo se deshidrata y se queda sin fuerzas.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON)),
    PokemonFB(841,"8",R.drawable.flapple, "Flapple","Usa fluidos corporales para reparar su manzana. Las de los más fuertes y curtidos en combate se vuelven de un color terroso.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON)),
    PokemonFB(842,"8",R.drawable.appletun, "Appletun","Escupen una sustancia pegajosa para ahuyentar a los Lechonk que se acercan a lamerles el dulce néctar de la espalda.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON)),
    PokemonFB(843,"8",R.drawable.silicobra, "Silicobra","Almacena la arena que ingiere al perforar hoyos en la saca del cuello, cuya capacidad llega a alcanzar incluso los 8 kg.",listOf(PokemonTipoFB.TIERRA)),
    PokemonFB(844,"8",R.drawable.sandaconda, "Sandaconda","Estira y contrae su cuerpo al máximo para expulsar arena con tal potencia que puede mover incluso un camión.",listOf(PokemonTipoFB.TIERRA)),
    PokemonFB(845,"8",R.drawable.cramorant, "Cramorant","Cuando tiene el estómago lleno, le cuesta moverse y corre el riesgo de ser engullido por algún Cramorant.",listOf(PokemonTipoFB.VOLADOR,PokemonTipoFB.AGUA)),
    PokemonFB(846,"8",R.drawable.arrokuda, "Arrokuda","Puede nadar a más de 100 nudos. Entabla encarnizadas batallas contra manadas de Finizen por la comida.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(847,"8",R.drawable.barraskewda, "Barraskewda","Puede nadar a más de 100 nudos. Entabla encarnizadas batallas contra manadas de Finizen por la comida.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(848,"8",R.drawable.toxel, "Toxel","Secreta toxinas por la piel y las almacena en una bolsa de veneno interna. Tocarlo da calambre.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.VENENO)),
    PokemonFB(849,"8",R.drawable.toxtricity, "Toxtricity","Cuando rasga las protuberancias del pecho para generar energía eléctrica, emite un sonido similar al de una guitarra, que reverbera en el entorno.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.VENENO)),
    PokemonFB(850,"8",R.drawable.sizzlipede, "Sizzlipede","Oprime a sus presas con su cuerpo candente. Una vez bien tostadas, las devora con fruición.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.BICHO)),
    PokemonFB(851,"8",R.drawable.centiskorch, "Centiskorch","Cuando genera calor, su temperatura corporal alcanza aproximadamente los 800 °C. Usa el cuerpo a modo de látigo para lanzarse al ataque.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.BICHO)),
    PokemonFB(852,"8",R.drawable.clobbopus, "Clobbopus","Emerge a tierra firme en busca de alimento. Su extrema curiosidad lo induce a golpear con los tentáculos todo lo que entra en su campo visual.",listOf(PokemonTipoFB.LUCHA)),
    PokemonFB(853,"8",R.drawable.grapploct, "Grapploct","Se aventura en tierra firme para buscar rivales contra los que luchar para medir su valía. Tras terminar el combate, regresa al mar.",listOf(PokemonTipoFB.LUCHA)),
    PokemonFB(854,"8",R.drawable.sinistea, "Sinistea","Según se dice, este Pokémon surgió de un alma solitaria que poseyó una taza abandonada llena de un té ya frío.",listOf(PokemonTipoFB.FANTASMA)),
    PokemonFB(855,"8",R.drawable.polteageist, "Polteageist","Se hospeda en teteras dignas de un anticuario. Las originales son escasísimas, pero existe un gran número de burdas falsificaciones.",listOf(PokemonTipoFB.FANTASMA)),
    PokemonFB(856,"8",R.drawable.hatenna, "Hatenna","Siente predilección por los lugares despoblados. Si percibe una emoción intensa, emprende la huida a toda prisa.",listOf(PokemonTipoFB.PSIQUICO)),
    PokemonFB(857,"8",R.drawable.hattrem, "Hattrem","Silencia al objetivo atizándole con los mechones. Despliega una potencia devastadora capaz de noquear a un boxeador profesional.",listOf(PokemonTipoFB.PSIQUICO)),
    PokemonFB(858,"8",R.drawable.hatterene, "Hatterene","Inmoviliza con un rayo y destroza con su garra reforzada con poder psíquico a todo aquel que se adentre en el bosque que habita.",listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.HADA)),
    PokemonFB(859,"8",R.drawable.impidimp, "Impidimp","Con el fin de revitalizarse, inhala por la nariz la energía negativa que desprenden tanto personas como Pokémon cuando están descontentos.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.HADA)),
    PokemonFB(860,"8",R.drawable.morgrem, "Morgrem","De noche, atrae con astucia a su objetivo hasta el bosque. Al parecer, tiene la capacidad de hacer crecer productos agrícolas.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.HADA)),
    PokemonFB(861,"8",R.drawable.grimmsnarl, "Grimmsnarl","Vive en lo más profundo del bosque. A pesar de haber evolucionado, no abandona las pequeñas bromas y las trastadas.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.HADA)),
    PokemonFB(862,"8",R.drawable.obstagoon, "Obstagoon","La potencia de su voz es realmente pasmosa. La técnica que usa para intimidar al rival mientras grita recibe el nombre de Obstrucción.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.NORMAL)),
    PokemonFB(863,"8",R.drawable.perrserker, "Perrserker","El pelo de la cabeza se le ha endurecido hasta el punto de parecer un yelmo de hierro. Posee un temperamento muy combativo.",listOf(PokemonTipoFB.ACERO)),
    PokemonFB(864,"8",R.drawable.cursola, "Cursola","Su energía espiritual ha aumentado hasta hacerlo desprenderse de su base caliza. Protege el alma del núcleo con su cuerpo espectral.",listOf(PokemonTipoFB.FANTASMA)),
    PokemonFB(865,"8",R.drawable.sirfetchd, "Sirfetch'd","Repele ataques con las hojas de su duro puerro y contraataca con su tallo afilado. El puerro que le sirve de armamento sigue siendo comestible.",listOf(PokemonTipoFB.LUCHA)),
    PokemonFB(866,"8",R.drawable.mrrime, "Mr. Rime","Es un bailarín consumado de claqué. Agita su bastón de hielo mientras exhibe su destreza con gráciles pasos.",listOf(PokemonTipoFB.HIELO,PokemonTipoFB.PSIQUICO)),
    PokemonFB(867,"8",R.drawable.runerigus, "Runerigus","Una poderosa maldición pesa sobre esta antigua imagen grabada, que ha cobrado vida tras adueñarse del alma de Yamask.",listOf(PokemonTipoFB.TIERRA,PokemonTipoFB.FANTASMA)),
    PokemonFB(868,"8",R.drawable.milcery, "Milcery","Su cremoso cuerpo surgió a partir de la unión de partículas odoríferas de dulces aromas presentes en el aire.",listOf(PokemonTipoFB.HADA)),
    PokemonFB(869,"8",R.drawable.alcremie, "Alcremie","Obsequia bayas decoradas con nata a aquellos Entrenadores en los que confía.",listOf(PokemonTipoFB.HADA)),
    PokemonFB(870,"8",R.drawable.falinks, "Falinks","Este Pokémon consta de cinco subalternos y un líder, cuyas órdenes obedecen sin rechistar.",listOf(PokemonTipoFB.LUCHA)),
    PokemonFB(871,"8",R.drawable.pincurchin, "Pincurchin","Libera electricidad por la punta de las púas. Con sus afilados dientes raspa las algas pegadas a las rocas para ingerirlas.",listOf(PokemonTipoFB.HIELO,PokemonTipoFB.BICHO)),
    PokemonFB(872,"8",R.drawable.snom, "Snom","Teje un hilo gélido que le permite aferrarse a las ramas y simula ser un carámbano mientras duerme.",listOf(PokemonTipoFB.HIELO,PokemonTipoFB.BICHO)),
    PokemonFB(873,"8",R.drawable.frosmoth, "Frosmoth","La temperatura de sus alas es de -180 °C. Sobrevuela el campo esparciendo sus gélidas escamas, como si de nieve se tratase.",listOf(PokemonTipoFB.HIELO,PokemonTipoFB.BICHO)),
    PokemonFB(874,"8",R.drawable.stonjourner, "Stonjourner","Una vez al año y en una fecha concreta, tienen la costumbre de aparecer de la nada para reunirse y formar un círculo.",listOf(PokemonTipoFB.ROCA)),
    PokemonFB(875,"8",R.drawable.eiscue, "Eiscue","La corriente lo ha transportado hasta aquí desde un lugar sumamente gélido. Utiliza el hielo para mantener la cara refrigerada en todo momento.",listOf(PokemonTipoFB.HIELO)),
    PokemonFB(876,"8",R.drawable.indeedee, "Indeedee","Percibe las emociones del objetivo con los cuernos de la cabeza. Los machos están atentos a cualquier cosa que necesite su Entrenador.",listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.NORMAL)),
    PokemonFB(877,"8",R.drawable.morpeko, "Morpeko","Siempre tiene hambre. Se nutre de las semillas que guarda en una suerte de bolsillos para generar electricidad.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.SINIESTRO)),
    PokemonFB(878,"8",R.drawable.cufant, "Cufant","Su constitución fornida le permite transportar sin inmutarse cargas de 5 toneladas. Utiliza la trompa para excavar la tierra.",listOf(PokemonTipoFB.ACERO)),
    PokemonFB(879,"8",R.drawable.copperajah, "Copperajah","Es orgulloso y difícil de tratar. Aquellos con un tono de piel verde más vivo se ganan el respeto de sus congéneres.",listOf(PokemonTipoFB.ACERO)),
    PokemonFB(880,"8",R.drawable.dracozolt, "Dracozolt","La robustez de su tren inferior lo hacía invencible en la antigüedad, pero se extinguió tras comerse todas las plantas de las que se nutría.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.DRAGON)),
    PokemonFB(881,"8",R.drawable.arctozolt, "Arctozolt","La parte superior del cuerpo está congelada y, al temblar, genera electricidad. Camina con suma dificultad.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.HIELO)),
    PokemonFB(882,"8",R.drawable.dracovish, "Dracovish","Exhibe con orgullo su inmensa capacidad motriz, que le permite superar los 60 km/h, pero solo puede respirar bajo el agua.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.DRAGON)),
    PokemonFB(883,"8",R.drawable.arctovish, "Arctovish","Atrapa a sus presas congelando su entorno, pero la ubicación de la boca encima de la cabeza le genera dificultades para deglutirlas.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.DRAGON)),
    PokemonFB(884,"8",R.drawable.duraludon, "Duraludon","Su cuerpo, compuesto de un metal especial, es tan liso como si tuviese un acabado de espejo. Además de ligero, es resistente a las rayaduras.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.DRAGON)),
    PokemonFB(885,"8",R.drawable.dreepy, "Dreepy","Habitaba los mares en tiempos inmemoriales. Ha revivido en forma de Pokémon de tipo Fantasma para vagar por su antigua morada.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.FANTASMA)),
    PokemonFB(886,"8",R.drawable.drakloak, "Drakloak","Vuela a una velocidad de 200 km/h. Lucha junto a un Dreepy, al que cuida hasta el momento de su evolución.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.FANTASMA)),
    PokemonFB(887,"8",R.drawable.dragapult, "Dragapult","Vive en compañía de Dreepy, a los que hospeda en el interior de sus cuernos. Los dispara a velocidad supersónica en combate.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.FANTASMA)),
    PokemonFB(888,"8",R.drawable.zacian, "Zacian","Este Pokémon está considerado como un héroe de leyenda. Absorbe el metal para transformarlo y emplearlo como armamento.",listOf(PokemonTipoFB.HADA,PokemonTipoFB.ACERO)),
    PokemonFB(889,"8",R.drawable.zamazenta, "Zamazenta","Este Pokémon se erigió en salvador de Galar, tras unir fuerzas con un rey de los hombres. Absorbe el metal para utilizarlo en combate.",listOf(PokemonTipoFB.LUCHA,PokemonTipoFB.ACERO)),
    PokemonFB(890,"8",R.drawable.eternatus, "Eternatus","Se alimenta de la energía que brota de la tierra de Galar absorbiéndola por el núcleo del pecho.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.DRAGON)),
    PokemonFB(891,"8",R.drawable.kubfu, "Kubfu","Perfecciona su técnica mediante una estricta disciplina. Según la corriente marcial que siga, adoptará una forma u otra al evolucionar.",listOf(PokemonTipoFB.LUCHA)),
    PokemonFB(892,"8",R.drawable.urshifu, "Urshifu","Su estilo de combate se inspira en el flujo del agua y consiste en castigar al oponente de forma constante e ininterrumpida.",listOf(PokemonTipoFB.LUCHA,PokemonTipoFB.SINIESTRO)),
    PokemonFB(893,"8",R.drawable.zarude, "Zarude","Viven en manada en la selva. Debido a su marcada agresividad, son muy temidos por otros Pokémon selváticos.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.PLANTA)),
    PokemonFB(894,"8",R.drawable.regieleki, "Regieleki","Su cuerpo entero es energía eléctrica. Por lo visto, quitarle los anillos que lleva libera su poder oculto.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(895,"8",R.drawable.regidrago, "Regidrago","Todo su cuerpo es una gema de energía dragón cristalizada. Se cree que posee los poderes de todos los Pokémon dragón.",listOf(PokemonTipoFB.DRAGON)),
    PokemonFB(896,"8",R.drawable.glastrier, "Glastrier","Libera un potente vaho gélido por las pezuñas. Un ser violento que no duda en tomar a la fuerza todo cuanto desea.",listOf(PokemonTipoFB.HIELO)),
    PokemonFB(897,"8",R.drawable.spectrier, "Spectrier","Examina su entorno con todos los sentidos, salvo la vista. Se dice que sus coces son capaces de robarle el alma a quien las recibe.",listOf(PokemonTipoFB.FANTASMA)),
    PokemonFB(898,"8",R.drawable.calyrex, "Calyrex","Un Pokémon muy compasivo agraciado con el poder de la curación. Reinó en Galar en tiempos remotos.",listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.PLANTA)),
    PokemonFB(899,"8",R.drawable.wyrdeer, "Wyrdeer","Sus orbes negros brillan con un fulgor misterioso cuando erige muros invisibles. El pelaje que se desprende de sus barbas es muy codiciado para crear cálidos ropajes para el invierno.",listOf(PokemonTipoFB.NORMAL,PokemonTipoFB.PSIQUICO)),
    PokemonFB(900,"8",R.drawable.kleavor, "Kleavor","Un Pokémon violento, tosco y rudo. Blande sus enormes y pesadas hachas de piedra para acabar con sus presas.",listOf(PokemonTipoFB.BICHO,PokemonTipoFB.ROCA)),
    PokemonFB(901,"8",R.drawable.ursaluna, "Ursaluna","Tengo la teoría de que el terreno pantanoso de Hisui favoreció el desarrollo de su constitución robusta, así como su capacidad de manipular la turba a voluntad.",listOf(PokemonTipoFB.TIERRA,PokemonTipoFB.NORMAL)),
    PokemonFB(902,"8",R.drawable.basculegion, "Basculegion","Durante las remontadas de los ríos, se envuelve de las almas de sus congéneres caídos en la ardua travesía. No tiene rival en ninguna de las corrientes que fluyen por la región de Hisui.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.FANTASMA)),
    PokemonFB(903,"8",R.drawable.sneasler, "Sneasler","Gracias a su fortaleza física y potente veneno, ninguna especie de las alturas heladas le planta cara. Es de personalidad solitaria y no forma manadas.",listOf(PokemonTipoFB.LUCHA,PokemonTipoFB.VENENO)),
    PokemonFB(904,"8",R.drawable.overqwil, "Overqwil","Sus púas tóxicas reaccionan como acto reflejo ante cualquier movimiento, por lo que ensartará todo lo que se acerque incluso mientras duerme.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.VENENO)),
    PokemonFB(905,"8",R.drawable.enamorus, "Enamorus","Su llegada de allende el mar significa el fin del duro invierno. De acuerdo con el folclore, su amor siempre trae consigo un soplo de vida nueva a Hisui.",listOf(PokemonTipoFB.HADA,PokemonTipoFB.VOLADOR)),
    PokemonFB(906,"9",R.drawable.sprigatito, "Sprigatito","Su sedoso pelaje se asemeja en composición a las plantas. Se lava la cara con diligencia para que no se le seque.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(907,"9",R.drawable.floragato, "Floragato","Maneja diestramente la vid oculta bajo su largo pelaje y propina latigazos al enemigo con el capullo endurecido de la punta.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(908,"9",R.drawable.meowscarada, "Meowscarada","Se sirve de la luz que reflejan los tricomas de su manto de hojas para camuflar la vid y crear la ilusión óptica de que la flor flota en el aire.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(909,"9",R.drawable.fuecoco, "Fuecoco","Yace sobre rocas calientes, cuyo calor transforma en energía ígnea tras absorberlo por sus escamas rectangulares.",listOf(PokemonTipoFB.FUEGO)),
    PokemonFB(910,"9",R.drawable.crocalor, "Crocalor","La mezcla de energía ígnea con el exceso de su propia fuerza vital ha tomado la forma de una bola de fuego de aspecto oval sobre su cabeza.",listOf(PokemonTipoFB.FUEGO)),
    PokemonFB(911,"9",R.drawable.skeledirge, "Skeledirge","Su dulce canto calma el espíritu de quien lo oye. Achicharra a sus enemigos con llamas que llegan a alcanzar los 3000ºC.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.FANTASMA)),
    PokemonFB(912,"9",R.drawable.quaxly, "Quaxly","Un Pokémon llegado hace tiempo desde tierras lejanas y ya establecido en la región. El gel que secreta por las plumas repele el agua y la mugre.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(913,"9",R.drawable.quaxwell, "Quaxwell","Fortalece las extremidades corriendo con tesón por los bajíos. Compite con los suyos para ver cuál posee una técnica más grácil con las patas.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(914,"9",R.drawable.quaquaval, "Quaquaval","Embelesa a quien lo ve con una danza que rebosa de exotismo y corta a sus rivales con sus plumas ornamentales hechas de agua.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.LUCHA)),
    PokemonFB(915,"9",R.drawable.lechonk, "Lechonk","Posee un olfato muy desarrollado que emplea únicamente para buscar comida, actividad a la que dedica el día entero.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(916,"9",R.drawable.oinkologne, "Oinkologne","Su piel suave y lustrosa es su mayor orgullo. Desprende una fragancia concentrada por la punta de la cola.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(917,"9",R.drawable.tarountula, "Tarountula","La bola de hilo que le rodea el cuerpo es lo bastante elástica como para repeler las guadañas de los Scyther, su enemigo natural.",listOf(PokemonTipoFB.BICHO)),
    PokemonFB(918,"9",R.drawable.spidops, "Spidops","Protege su territorio cubriéndolo con una tela de hilo resistente y pegajoso que actúa como una trampa frente a los intrusos.",listOf(PokemonTipoFB.BICHO)),
    PokemonFB(919,"9",R.drawable.nymble, "Nymble","Mantiene plegado su tercer par de patas, cuya fuerza le permite saltar a más de 10 m de altura para huir en caso de apuro.",listOf(PokemonTipoFB.BICHO)),
    PokemonFB(920,"9",R.drawable.lokix, "Lokix","Cuando decide luchar sin cuartel, se alza con su tercer par de patas y entra en modo asalto. Acaba con el rival en un abrir y cerrar de ojos.",listOf(PokemonTipoFB.BICHO,PokemonTipoFB.SINIESTRO)),
    PokemonFB(921,"9",R.drawable.pawmi, "Pawmi","Como las bolsas de sus mejillas están poco desarrolladas, genera electricidad frotándolas con las almohadillas de sus patas delanteras.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(922,"9",R.drawable.pawmo, "Pawmo","Usa un arte marcial caracterizado por emplear las patas delanteras para asestar golpes y liberar descargas eléctricas al mismo tiempo.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.LUCHA)),
    PokemonFB(923,"9",R.drawable.pawmot, "Pawmot","Su mullido pelaje actúa como una batería. Es capaz de almacenar tanta electricidad como un coche eléctrico.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.LUCHA)),
    PokemonFB(924,"9",R.drawable.tandemaus, "Tandemaus","Siempre van en pareja. Cuando encuentran comida, la dividen en dos partes idénticas para compartirla.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(925,"9",R.drawable.maushold, "Maushold","Construyen grandes nidos que dividen en varias cámaras destinadas a distintas funciones, como dormir o comer.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(926,"9",R.drawable.fidough, "Fidough","Resulta húmedo y suave al tacto. Hace fermentar las cosas a su alrededor con la levadura de su aliento.",listOf(PokemonTipoFB.HADA)),
    PokemonFB(927,"9",R.drawable.dachsbun, "Dachsbun","La superficie de su piel se endurece cuando se expone a un calor intenso. Su cuerpo desprende un fragante aroma.",listOf(PokemonTipoFB.HADA)),
    PokemonFB(928,"9",R.drawable.smoliv, "Smoliv","Se defiende de sus rivales segregando por el fruto de su cabeza un aceite tan amargo y agrio que cualquiera daría un respingo al probarlo.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.NORMAL)),
    PokemonFB(929,"9",R.drawable.dolliv, "Dolliv","No duda en compartir su delicioso aceite de fresco aroma. Convive con los seres humanos desde hace mucho tiempo.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.NORMAL)),
    PokemonFB(930,"9",R.drawable.arboliva, "Arboliva","Es pacífico y compasivo. Comparte su delicioso y nutritivo aceite con los Pokémon que han perdido las fuerzas.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.NORMAL)),
    PokemonFB(931,"9",R.drawable.squawkabilly, "Squawkabilly","Prefieren vivir en las ciudades. Forman bandadas según el color de su plumaje y libran disputas por el control de los territorios.",listOf(PokemonTipoFB.NORMAL,PokemonTipoFB.VOLADOR)),
    PokemonFB(932,"9",R.drawable.nacli, "Nacli","Arrastra el cuerpo por el suelo al desplazarse, por lo que deja un rastro de sal. La fabrica y repone continuamente en su interior.",listOf(PokemonTipoFB.ROCA)),
    PokemonFB(933,"9",R.drawable.naclstack, "Naclstack","Escupe sal para recubrir con ella a sus presas y someterlas a un proceso de salazón que extrae la humedad de sus cuerpos.",listOf(PokemonTipoFB.ROCA)),
    PokemonFB(934,"9",R.drawable.garganacl, "Garganacl","Muchos Pokémon se arremolinan alrededor de Garganacl para lamer su sal rica en minerales.",listOf(PokemonTipoFB.ROCA)),
    PokemonFB(935,"9",R.drawable.charcadet, "Charcadet","Sus potentes llamas alcanzan los 1000ºC cuando combate. Siente predilección por las bayas con un alto contenido graso.",listOf(PokemonTipoFB.FUEGO)),
    PokemonFB(936,"9",R.drawable.armarouge, "Armarouge","Evolucionó al portar la armadura de un guerrero de renombre. Este Pokémon destaca por su gran lealtad.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.PSIQUICO)),
    PokemonFB(937,"9",R.drawable.ceruledge, "Ceruledge","Evolucionó al portar una vieja armadura cargada de rencor. Despedaza a sus enemigos sin piedad alguna.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.FANTASMA)),
    PokemonFB(938,"9",R.drawable.tadbulb, "Tadbulb","Produce electricidad agitando la cola. Si siente peligro, hace parpadear su cabeza para alertar a sus compañeros.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(939,"9",R.drawable.bellibolt, "Bellibolt","Los órganos que parecen ojos sirven en realidad para descargar toda la electricidad generada por la dinamo de su ombligo.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(940,"9",R.drawable.wattrel, "Wattrel","Anida en acantilados costeros. Su nido se considera un auténtico manjar debido a su extraña textura chisporroteante.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.VOLADOR)),
    PokemonFB(941,"9",R.drawable.kilowattrel, "Kilowattrel","Almacena la electricidad generada por sus alas en el saco gular. Su plumaje apenas contiene aceite, por lo que es un pésimo nadador.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.VOLADOR)),
    PokemonFB(942,"9",R.drawable.maschiff, "Maschiff","Mantiene el ceño fruncido para que sus rivales lo tomen en serio, pero hasta el niño más llorón estallaría en carcajadas al ver su mueca.",listOf(PokemonTipoFB.SINIESTRO)),
    PokemonFB(943,"9",R.drawable.mabosstiff, "Mabosstiff","Almacena energía en la papada y la libera toda de golpe para arrasar con sus rivales.",listOf(PokemonTipoFB.SINIESTRO)),
    PokemonFB(944,"9",R.drawable.shroodle, "Shroodle","Es manso, pero muerde y paraliza a quien lo enfada con sus afilados incisivos impregnados de toxinas.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.NORMAL)),
    PokemonFB(945,"9",R.drawable.grafaiai, "Grafaiai","Cada individuo pinta un patrón único y distintivo que irá replicando de forma constante a lo largo de toda su vida.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.NORMAL)),
    PokemonFB(946,"9",R.drawable.bramblin, "Bramblin","Rueda por los páramos a merced del viento, sin que él mismo sepa dónde recalará. No soporta mojarse.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.FANTASMA)),
    PokemonFB(947,"9",R.drawable.brambleghast, "Brambleghast","Despliega las ramas para engullir a sus presas. Cuando ha terminado de absorber su energía vital, las escupe.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.FANTASMA)),
    PokemonFB(948,"9",R.drawable.toedscool, "Toedscool","Los pliegues ondulados que se desprenden de su cuerpo cuentan con una textura curiosa y un sabor delicioso. Habita en bosques húmedos.",listOf(PokemonTipoFB.TIERRA,PokemonTipoFB.PLANTA)),
    PokemonFB(949,"9",R.drawable.toedscruel, "Toedscruel","Forma colonias de varios ejemplares en lo más profundo de los bosques. No soporta las visitas indeseadas de extraños.",listOf(PokemonTipoFB.TIERRA,PokemonTipoFB.PLANTA)),
    PokemonFB(950,"9",R.drawable.klawf, "Klawf","Habita en acantilados escarpados. Evade los ataques enemigos echándose a un lado y luego apunta a sus puntos vitales con las pinzas.",listOf(PokemonTipoFB.ROCA)),
    PokemonFB(951,"9",R.drawable.capsakid, "Capsakid","En Paldea es común emplear los incisivos caídos de los Capsakid como ingrediente, lo que aporta un toque muy picante a los platos.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(952,"9",R.drawable.scovillain, "Scovillain","La cabeza verde es mucho más despiadada por el efecto de los capsaicinoides sobre su cerebro. Cuando enloquece, no hay forma de detenerla.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.FUEGO)),
    PokemonFB(953,"9",R.drawable.rellor, "Rellor","Hace rodar la bola de barro para madurar energía hasta que alcanza el grado necesario para su evolución.",listOf(PokemonTipoFB.BICHO)),
    PokemonFB(954,"9",R.drawable.rabsca, "Rabsca","Mece la bola suavemente con las patas para asegurar el plácido sueño de la crisálida que duerme en su interior.",listOf(PokemonTipoFB.BICHO,PokemonTipoFB.PSIQUICO)),
    PokemonFB(955,"9",R.drawable.flittle, "Flittle","La punta de sus extremidades levita a 1 cm del suelo a causa del poder psíquico que emiten los volantes de su abdomen.",listOf(PokemonTipoFB.PSIQUICO)),
    PokemonFB(956,"9",R.drawable.espathra, "Espathra","Emite energía psíquica por los huecos entre sus volantes multicolor y alcanza los 200 km/h en carrera.",listOf(PokemonTipoFB.PSIQUICO)),
    PokemonFB(957,"9",R.drawable.tinkatink, "Tinkatink","Agita su martillo forjado a mano para ahuyentar a posibles amenazas, pero los Pokémon que se alimentan a base de metal suelen robárselo.",listOf(PokemonTipoFB.HADA,PokemonTipoFB.ACERO)),
    PokemonFB(958,"9",R.drawable.tinkatuff, "Tinkatuff","Asalta el séquito entero de un Bisharp para reunir metal con el que forjar su enorme y robusto martillo.",listOf(PokemonTipoFB.HADA,PokemonTipoFB.ACERO)),
    PokemonFB(959,"9",R.drawable.tinkaton, "Tinkaton","Blande sin esfuerzo su pesado martillo de más de 100 kg. Cuando quiere algo, lo roba y se lo lleva de vuelta a su guarida.",listOf(PokemonTipoFB.HADA,PokemonTipoFB.ACERO)),
    PokemonFB(960,"9",R.drawable.wiglett, "Wiglett","Puede percibir el olor de los Veluza a 20m de distancia, lo que le permite ocultarse bajo la arena a tiempo.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(961,"9",R.drawable.wugtrio, "Wugtrio","Es de temperamento agresivo, aunque no lo parezca. Envuelve a sus presas con sus largos cuerpos y las arrastra a su nido.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(962,"9",R.drawable.bombirdier, "Bombirdier","Usa la bolsa del pecho para envolver comida y transportarla a su nido. Le encanta dejar caer objetos que hacen mucho ruido.",listOf(PokemonTipoFB.VOLADOR,PokemonTipoFB.SINIESTRO)),
    PokemonFB(963,"9",R.drawable.finizen, "Finizen","Su anillo de agua está compuesto por una mezcla de agua marina y de un líquido aglutinante que segrega por el espiráculo.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(964,"9",R.drawable.palafin, "Palafin","Sus genes primigenios han despertado y lo han dotado de tal fuerza que es capaz de acarrear un crucero con una sola aleta sin problema.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(965,"9",R.drawable.varoom, "Varoom","Se dice que surgió cuando un misterioso Pokémon venenoso tomó posesión de un motor abandonado en un desguace.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.VENENO)),
    PokemonFB(966,"9",R.drawable.revavroom, "Revavroom","Posee ocho cilindros, con los que genera energía haciendo estallar el gas que produce al mezclar los minerales de las rocas con su veneno.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.VENENO)),
    PokemonFB(967,"9",R.drawable.cyclizar, "Cyclizar","Según parece, ha permitido que los humanos monten en él desde tiempos remotos. Aparece en pinturas rupestres de hace diez mil años.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.NORMAL)),
    PokemonFB(968,"9",R.drawable.orthworm, "Orthworm","Cuando lo atacan, usa los pelos de su cuerpo a modo de puños y hace llover un aluvión de puñetazos sobre sus enemigos.",listOf(PokemonTipoFB.ACERO)),
    PokemonFB(969,"9",R.drawable.glimmet, "Glimmet","Absorbe nutrientes de las paredes de las cuevas. Cubre su cuerpo con pétalos hechos de energía venenosa cristalizada.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.VENENO)),
    PokemonFB(970,"9",R.drawable.glimmora, "Glimmora","En cuanto percibe peligro, abre sus pétalos de cristal y despide rayos por su cuerpo en forma de cono.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.VENENO)),
    PokemonFB(971,"9",R.drawable.greavard, "Greavard","Se cree que es la reencarnación de un Pokémon perro vagabundo que murió sin haber tenido contacto con humanos.",listOf(PokemonTipoFB.FANTASMA)),
    PokemonFB(972,"9",R.drawable.houndstone, "Houndstone","La reencarnación de un Pokémon muy querido y llorado. Odia que le toquen la protuberancia de la cabeza.",listOf(PokemonTipoFB.FANTASMA)),
    PokemonFB(973,"9",R.drawable.flamigo, "Flamigo","Al parecer, se anudan la base del cuello para impedir que la energía que tienen almacenada en el estómago escape por el pico.",listOf(PokemonTipoFB.VOLADOR,PokemonTipoFB.LUCHA)),
    PokemonFB(974,"9",R.drawable.cetoddle, "Cetoddle","Viven en manadas de unos cinco individuos en regiones gélidas. Les encantan los minerales presentes en la nieve y el hielo.",listOf(PokemonTipoFB.HIELO)),
    PokemonFB(975,"9",R.drawable.cetitan, "Cetitan","Este Pokémon vive en áreas cubiertas de nieve y hielo. Se protege con su fuerte musculatura y una gruesa capa de grasa subcutánea.",listOf(PokemonTipoFB.HIELO)),
    PokemonFB(976,"9",R.drawable.veluza, "Veluza","Al desechar la carne que no necesita, agudiza la mente y sus poderes psíquicos se incrementan. Dicha carne tiene un sabor suave pero exquisito.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.PSIQUICO)),
    PokemonFB(977,"9",R.drawable.dondozo, "Dondozo","Le gusta mucho comer, pero no se le da bien cazar, por lo que aúna fuerzas con Tatsugiri con el fin de capturar presas.",listOf(PokemonTipoFB.AGUA)),
    PokemonFB(978,"9",R.drawable.tatsugiri, "Tatsugiri","Pokémon dragón de pequeño tamaño. Vive en la boca de un Dondozo para protegerse de los ataques de los depredadores.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.AGUA)),
    PokemonFB(979,"9",R.drawable.annihilape, "Annihilape","Machaca sin piedad a sus rivales concentrando en los puños hasta el último ápice de ira albergada en su corazón.",listOf(PokemonTipoFB.LUCHA,PokemonTipoFB.FANTASMA)),
    PokemonFB(980,"9",R.drawable.clodsire, "Clodsire","Vive en el fondo de los estanques y pantanos. Nada con Wooper sobre el lomo para ayudarlos a cruzar de una orilla a otra.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.TIERRA)),
    PokemonFB(981,"9",R.drawable.farigiraf, "Farigiraf","La dura cabeza de la cola protege a la principal cuando agita su largo cuello para propinar cabezazos a sus enemigos.",listOf(PokemonTipoFB.NORMAL,PokemonTipoFB.PSIQUICO)),
    PokemonFB(982,"9",R.drawable.dudunsparce, "Dudunsparce","Usa su dura cola para horadar el lecho rocoso en las profundidades de la tierra y establecer su madriguera, cuyos túneles se extienden 10 km.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(983,"9",R.drawable.kingambit, "Kingambit","Solo el Bisharp más destacado entre las filas de cada gran ejército tiene el honor de evolucionar a Kingambit.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.ACERO)),
    PokemonFB(984,"9",R.drawable.colmilargo, "Colmilargo","Testigos afirman haberlo visto recientemente. El nombre Colmilargo está tomado de una criatura mencionada en cierto libro.",listOf(PokemonTipoFB.TIERRA,PokemonTipoFB.LUCHA)),
    PokemonFB(985,"9",R.drawable.colagrito, "Colagrito","Solo se había avistado una vez en el pasado. Su aspecto se asemeja al de una misteriosa criatura descrita en cierto diario antiguo.",listOf(PokemonTipoFB.HADA,PokemonTipoFB.PSIQUICO)),
    PokemonFB(986,"9",R.drawable.furioseta, "Furioseta","Es posible que se trate de la criatura que se menciona en cierto libro bajo el nombre de Furioseta.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.SINIESTRO)),
    PokemonFB(987,"9",R.drawable.melenaleteo, "Melenaleteo","Sus rasgos distintivos se asemejan a los del espíritu de un reptil volador mencionado en una revista esotérica.",listOf(PokemonTipoFB.FANTASMA,PokemonTipoFB.HADA)),
    PokemonFB(988,"9",R.drawable.reptalada, "Reptalada","Un misterioso Pokémon que presenta ciertas similitudes con Reptalada, una criatura descrita en un tomo antiguo.",listOf(PokemonTipoFB.BICHO,PokemonTipoFB.LUCHA)),
    PokemonFB(989,"9",R.drawable.pelarena, "Pelarena","Su aspecto recuerda ligeramente a un supuesto Magneton que ha vivido 10.000 años y cuya imagen se publicó en una revista esotérica.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.TIERRA)),
    PokemonFB(990,"9",R.drawable.ferrodada, "Ferrodada","Su aspecto recuerda al de un arma científica de origen extraterrestre que apareció en un artículo de una revista esotérica.",listOf(PokemonTipoFB.TIERRA,PokemonTipoFB.ACERO)),
    PokemonFB(991,"9",R.drawable.ferrosaco, "Ferrosaco","Tiene una forma similar a la del robot construido por una civilización antigua mencionado en cierto artículo de una revista esotérica.",listOf(PokemonTipoFB.HIELO,PokemonTipoFB.AGUA)),
    PokemonFB(992,"9",R.drawable.ferropalmas, "Ferropalmas","Este Pokémon comparte muchas características con Ferropalmas, un objeto descrito en cierto diario.",listOf(PokemonTipoFB.LUCHA,PokemonTipoFB.ELECTRICO)),
    PokemonFB(993,"9",R.drawable.ferrocuello, "Ferrocuello","Se asemeja a un Pokémon que apareció en una revista esotérica descrito como el fruto de un romance entre un Hydreigon y un robot.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.VOLADOR)),
    PokemonFB(994,"9",R.drawable.ferropolilla, "Ferropolilla","Nunca se había capturado uno, ergo los datos son escasos. Su descripción coincide con la de un objeto mencionado en unos viejos escritos.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.VENENO)),
    PokemonFB(995,"9",R.drawable.ferropuas, "Ferropúas","Algunos de sus rasgos distintivos coinciden con los de Ferropúas, un objeto que aparece mencionado en cierto diario.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.ELECTRICO)),
    PokemonFB(996,"9",R.drawable.frigibax, "Frigibax","Absorbe el calor a través de la placa dorsal y lo convierte en energía gélida. Cuanto más alta es la temperatura, más energía acumula.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.HIELO)),
    PokemonFB(997,"9",R.drawable.arctibax, "Arctibax","Congela el aire a su alrededor para cubrirse el rostro con una máscara de hielo protectora y dotar su placa dorsal de cuchillas glaciales.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.HIELO)),
    PokemonFB(998,"9",R.drawable.baxcalibur, "Baxcalibur","Exhala un aliento extremadamente frío por la boca que es capaz de congelar al instante incluso magma al rojo vivo.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.HIELO)),
    PokemonFB(999,"9",R.drawable.gimmighoul, "Gimmighoul","El cofre en el que nació data de hace 1500 años aproximadamente. Absorbe la energía vital de los granujas que intentan hacerse con su tesoro.",listOf(PokemonTipoFB.FANTASMA)),
    PokemonFB(1000,"9",R.drawable.gholdengo, "Gholdengo","Se dice que su cuerpo está formado por 1000 monedas. Es capaz de hacer buenas migas con cualquiera rápidamente por su sociabilidad.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.FANTASMA)),
    PokemonFB(1001,"9",R.drawable.wochien, "Wo-Chien","Este Pokémon nació al imbuirse en hojas marchitas el rencor de una persona castigada por enumerar las fechorías de su rey en unas tablillas.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.PLANTA)),
    PokemonFB(1002,"9",R.drawable.chienpao, "Chien-Pao","Controla a su voluntad masas de nieve de hasta cien toneladas. Se divierte zambulléndose y saltando felizmente en los aludes que provoca.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.HIELO)),
    PokemonFB(1003,"9",R.drawable.tinglu, "Ting-Lu","Este Pokémon nació al imbuirse en tierra y rocas el miedo vertido en un caldero que se utilizaba en rituales antiguos.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.TIERRA)),
    PokemonFB(1004,"9",R.drawable.chiyu, "Chi-Yu","Controla a su voluntad llamas de hasta 3000ºC. Nada tranquilamente por los mares de magma que crea al derretir las rocas y la grava a su paso.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.FUEGO)),
    PokemonFB(1005,"9",R.drawable.bramaluna, "Bramaluna","Podría tratarse de la criatura que aparece bajo el nombre de Bramaluna en cierto diario repleto de incógnitas.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.SINIESTRO)),
    PokemonFB(1006,"9",R.drawable.ferropaladin, "Ferropaladín","Comparte varios rasgos con el invento de un científico loco que apareció en un artículo de una revista esotérica.",listOf(PokemonTipoFB.HADA,PokemonTipoFB.LUCHA)),
    PokemonFB(1007,"9",R.drawable.koraidon, "Koraidon","Parece tratarse de Reyalado, la criatura que, según lo narrado en un antiguo diario, fue capaz de dividir la tierra con sus puños.",listOf(PokemonTipoFB.LUCHA,PokemonTipoFB.DRAGON)),
    PokemonFB(1008,"9",R.drawable.miraidon, "Miraidon","Pese a las similitudes con los Cyclizar, es mucho más fuerte y despiadado que ellos. Está rodeado de incógnitas.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.DRAGON)),
    PokemonFB(1009,"9",R.drawable.ondulagua, "Ondulagua","Se asemeja a la ilustración de un Suicune de tiempos inmemoriales que apareció publicada en cierta revista esotérica.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.DRAGON)),
    PokemonFB(1010,"9",R.drawable.ferroverdor, "Ferroverdor","Presenta numerosas características en común con el Virizion del futuro que apareció publicado en cierta revista esotérica.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.PSIQUICO)),
    PokemonFB(1011,"9",R.drawable.dipplin, "Dipplin","Ha evolucionado gracias a una manzana especial que solo se cultiva en cierta zona. Este Pokémon está formado por dos individuos.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON)),
    PokemonFB(1012,"9",R.drawable.poltchageist, "Poltchageist","Según se dice, el resquemor de un practicante de la ceremonia del té que murió sin perfeccionar el arte poseyó el matcha y dio lugar a un Pokémon.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.FANTASMA)),
    PokemonFB(1013,"9",R.drawable.sinistcha, "Sinistcha","Vive en un exquisito cuenco de té elaborado por un alfarero de renombre. Los coleccionistas más acérrimos se desviven por este Pokémon.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.FANTASMA)),
    PokemonFB(1014,"9",R.drawable.okidogi, "Okidogi","Las toxinas de la cadena que lleva al cuello producen una estimulación muscular que le ha conferido un cuerpo de lo más robusto.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.LUCHA)),
    PokemonFB(1015,"9",R.drawable.munkidori, "Munkidori","Las toxinas de la cadena, capaces de sacar a relucir su potencial, le han estimulado el cerebro y le han hecho desarrollar poderes psíquicos.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.PSIQUICO)),
    PokemonFB(1016,"9",R.drawable.fezandipiti, "Fezandipiti","Al agitar sus majestuosas alas, libera unas feromonas que dejan embelesados tanto a humanos como a Pokémon.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.HADA)),
    PokemonFB(1017,"9",R.drawable.ogerpon, "Ogerpon","Cambia de tipo según la máscara que lleve. Se vale de sus rápidos movimientos y patadas para jugar a su antojo con sus enemigos.",listOf(PokemonTipoFB.PLANTA)),
    PokemonFB(1018,"9",R.drawable.archaludon, "Archaludon","Acumula la electricidad estática de su entorno. El rayo que dispara cuando está a cuatro patas posee una potencia colosal.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.DRAGON)),
    PokemonFB(1019,"9",R.drawable.hydrapple, "Hydrapple","Se trata de siete seres llamados Viborappli que viven juntos en una manzana de caramelo. El del centro es el líder del grupo.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON)),
    PokemonFB(1020,"9",R.drawable.flamariete, "Flamariete","Apenas constan avistamientos de este Pokémon, pero existe una breve grabación donde aparece desbocado y escupiendo ráfagas de fuego.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.DRAGON)),
    PokemonFB(1021,"9",R.drawable.electrofuria, "Electrofuria","Se dice que calcina todo cuanto lo rodea con los rayos que libera su pelaje. Aparte de eso, se sabe muy poco sobre esta criatura.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.DRAGON)),
    PokemonFB(1022,"9",R.drawable.ferromole, "Ferromole","Su cuerpo parece estar compuesto enteramente de metal. Debe su nombre a un objeto descrito en un tomo antiguo.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.PSIQUICO)),
    PokemonFB(1023,"9",R.drawable.ferrotesta, "Ferrotesta","Se dice que puede cortarlo todo a su alrededor lanzando afiladas hojas luminosas, pero nada más se sabe acerca de esta criatura.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.PSIQUICO)),
    PokemonFB(1024,"9",R.drawable.terapagos, "Terapagos","Se vale de su capacidad para transformar energía en duros cristales para protegerse. Este Pokémon dio origen a la teracristalización.",listOf(PokemonTipoFB.NORMAL)),
    PokemonFB(1025,"9",R.drawable.pecharunt, "Pecharunt","Su caparazón con forma de melocotón alberga un potente veneno con el que prepara un mochi tóxico que ofrece a humanos y Pokémon.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.FANTASMA)),
