...
var listaPokeFB : List<PokemonFB> = listOf(
    ...
    PokemonFB(835,"8",R.drawable.yamper, "Yamper","Controla los poderes y las raíces de su singular tocón en combate golpeándolo como si fuera un tambor.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(836,"8",R.drawable.boltund, "Boltund","Controla los poderes y las raíces de su singular tocón en combate golpeándolo como si fuera un tambor.",listOf(PokemonTipoFB.ELECTRICO)),
    PokemonFB(837,"8",R.drawable.rolycoly, "Rolycoly","Controla los poderes y las raíces de su singular tocón en combate golpeándolo como si fuera un tambor.",listOf(PokemonTipoFB.ROCA)),
    PokemonFB(838,"8",R.drawable.carkol, "Carkol","Controla los poderes y las raíces de su singular tocón en combate golpeándolo como si fuera un tambor.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.FUEGO)),
    PokemonFB(839,"8",R.drawable.coalossal, "Coalossal","Controla los poderes y las raíces de su singular tocón en combate golpeándolo como si fuera un tambor.",listOf(PokemonTipoFB.ROCA,PokemonTipoFB.FUEGO)),
