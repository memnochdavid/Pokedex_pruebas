...
/*
    ...
    PokemonFB(113,"1",R.drawable.chansey, "Chansey", "Este amable Pokémon es capaz de compartir sus nutrientes huevos con un Pokémon herido.", listOf(PokemonTipoFB.NORMAL), listOf(113,242)),
    ...
    PokemonFB(122,"1",R.drawable.mrmime, "Mr. Mime", "Siempre practica la misma pantomima. Hace creer al enemigo que existe algo que no es real.", listOf(PokemonTipoFB.PSIQUICO, PokemonTipoFB.HADA), listOf(439,122,866)),
    ...
    PokemonFB(238,"2",R.drawable.smoochum, "Smoochum","Sus labios son la parte más sensible de su cuerpo. Siempre los usa para examinar las cosas.",listOf(PokemonTipoFB.HIELO,PokemonTipoFB.PSIQUICO), listOf(124, 238, 239)),
    PokemonFB(239,"2",R.drawable.elekid, "Elekid","Entre sus cuernos pasa una débil corriente eléctrica. Quien ponga ahí la mano se dará un calambrazo.",listOf(PokemonTipoFB.ELECTRICO), listOf(125, 239, 240)),
    PokemonFB(240,"2",R.drawable.magby, "Magby","Aparece en los cráteres de los volcanes. Puede alcanzar los 600 grados de temperatura, así que no lo subestimes.",listOf(PokemonTipoFB.FUEGO), listOf(126, 240, 241)),
    ...
    PokemonFB(242,"2",R.drawable.blissey, "Blissey","Cualquiera que pruebe un poco de huevo de Blissey, se volverá más amable y agradable con todos.",listOf(PokemonTipoFB.NORMAL), listOf(113, 242)),
    ...
    PokemonFB(280,"3",R.drawable.ralts, "Ralts","Si sus cuernos perciben emociones positivas de personas o Pokémon, su cuerpo se calienta un poco.",listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.HADA), listOf(280, 281, 282)),
    PokemonFB(281,"3",R.drawable.kirlia, "Kirlia","Si su entrenador está contento, se llena de energía y baila de forma alegre dando giros.",listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.HADA), listOf(280, 281, 282)),
    ...
    PokemonFB(298,"3",R.drawable.azurill, "Azurill","Su cola rebota como una pelota. Para luchar contra enemigos más grandes, la agita en el aire.",listOf(PokemonTipoFB.NORMAL,PokemonTipoFB.HADA), listOf(183, 298, 311, 312)),
    ...
    PokemonFB(424,"4",R.drawable.aipom, "Aipom","Usando sus colas, AMBIPOM puede propinar golpes sucesivos a velocidad de vértigo que son imposibles de esquivar.",listOf(PokemonTipoFB.NORMAL), listOf(190,424)),
    ...
    PokemonFB(439,"4",R.drawable.mimejr, "Mime Jr.","Cuando tiene a alguien delante imita su expresión y movimientos para extender sus sentimientos.",listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.HADA), listOf(122, 439)),
    PokemonFB(440,"4",R.drawable.happiny, "Happiny","Le encantan las cosas blancas y redondas. Imita a Chansey llevando una roca en forma de huevo.",listOf(PokemonTipoFB.NORMAL), listOf(113, 440, 242)),
    ...
    PokemonFB(466,"4",R.drawable.electivire, "Electivire","Al almacenar mucha electricidad, desprende chispas de una claridad increíble entre sus dos cuernos.",listOf(PokemonTipoFB.ELECTRICO), listOf(125, 126, 466)),
    PokemonFB(467,"4",R.drawable.magmortar, "Magmortar","Cuando lanza sus bolas de fuego a 2000 grados, su cuerpo adquiere un tono blanquecino por el calor.",listOf(PokemonTipoFB.FUEGO), listOf(126, 127, 467)),
    ...
    PokemonFB(475,"4",R.drawable.gallade, "Gallade","Cuando quiere proteger a alguien, extiende los codos como si fueran espadas y lucha con fiereza.",listOf(PokemonTipoFB.PSIQUICO,PokemonTipoFB.LUCHA), listOf(280, 281, 282, 475)),
    ...
    PokemonFB(550,"5",R.drawable.basculin, "Basculin","Los de color azul y los de color rojo siempre se pelean. Son muy violentos, pero su sabor es excepcional.",listOf(PokemonTipoFB.AGUA), listOf(550)),
    ...
    PokemonFB(562,"5",R.drawable.yamask, "Yamask","Almas de humanos sepultados en tumbas que han adquirido forma de Pokémon. Recuerdan su vida antes de la muerte.",listOf(PokemonTipoFB.FANTASMA), listOf(562, 563, 776)),
    PokemonFB(563,"5",R.drawable.cofagrigus, "Cofagrigus","Atrapan en su interior a los ladrones de tumbas que los confunden con ataúdes de verdad.",listOf(PokemonTipoFB.FANTASMA), listOf(562, 563, 776)),
    ...
    PokemonFB(624,"5",R.drawable.pawniard, "Pawniard","Lucha bajo las órdenes de Bisharp. Se agarra a sus oponentes y les inflige daño utilizando sus cuchillas.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.ACERO), listOf(624, 625)),
    PokemonFB(625,"5",R.drawable.bisharp, "Bisharp","Su séquito son los Pawniard. Acorralan a su presa con todo el grupo y Bisharp propina el golpe de gracia.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.ACERO), listOf(624, 625)),
...
/*
    ...
    PokemonFB(840,"8",R.drawable.applin, "Applin","Vive dentro de una manzana. Si se separa de ella, su cuerpo se deshidrata y se queda sin fuerzas.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON), listOf(840, 841, 842)),
    PokemonFB(841,"8",R.drawable.flapple, "Flapple","Usa fluidos corporales para reparar su manzana. Las de los más fuertes y curtidos en combate se vuelven de un color terroso.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON), listOf(840, 841)),
    PokemonFB(842,"8",R.drawable.appletun, "Appletun","Escupen una sustancia pegajosa para ahuyentar a los Lechonk que se acercan a lamerles el dulce néctar de la espalda.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON), listOf(840, 842)),
    ...
    PokemonFB(854,"8",R.drawable.sinistea, "Sinistea","Según se dice, este Pokémon surgió de un alma solitaria que poseyó una taza abandonada llena de un té ya frío.",listOf(PokemonTipoFB.FANTASMA), listOf(854, 855,855)),
    PokemonFB(855,"8",R.drawable.polteageist, "Polteageist","Se hospeda en teteras dignas de un anticuario. Las originales son escasísimas, pero existe un gran número de burdas falsificaciones.",listOf(PokemonTipoFB.FANTASMA), listOf(854, 855,855)),
    ...
    PokemonFB(862,"8",R.drawable.obstagoon, "Obstagoon","La potencia de su voz es realmente pasmosa. La técnica que usa para intimidar al rival mientras grita recibe el nombre de Obstrucción.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.NORMAL), listOf(862,865,862)),
    ...
    PokemonFB(864,"8",R.drawable.cursola, "Cursola","Su energía espiritual ha aumentado hasta hacerlo desprenderse de su base caliza. Protege el alma del núcleo con su cuerpo espectral.",listOf(PokemonTipoFB.FANTASMA), listOf(864)),
    ...
    PokemonFB(884,"8",R.drawable.duraludon, "Duraludon","Su cuerpo, compuesto de un metal especial, es tan liso como si tuviese un acabado de espejo. Además de ligero, es resistente a las rayaduras.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.DRAGON), listOf(884)),
    ...
    PokemonFB(902,"8",R.drawable.basculegion, "Basculegion","Durante las remontadas de los ríos, se envuelve de las almas de sus congéneres caídos en la ardua travesía. No tiene rival en ninguna de las corrientes que fluyen por la región de Hisui.",listOf(PokemonTipoFB.AGUA,PokemonTipoFB.FANTASMA), listOf(902,782,902)),
    ...
    PokemonFB(904,"8",R.drawable.overqwil, "Overqwil","Sus púas tóxicas reaccionan como acto reflejo ante cualquier movimiento, por lo que ensartará todo lo que se acerque incluso mientras duerme.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.VENENO), listOf(904,784,904)),
    ...
    PokemonFB(931,"9",R.drawable.squawkabilly, "Squawkabilly","Prefieren vivir en las ciudades. Forman bandadas según el color de su plumaje y libran disputas por el control de los territorios.",listOf(PokemonTipoFB.NORMAL,PokemonTipoFB.VOLADOR), listOf(931,931,931)), // Squawkabilly tiene 4 formas: Azul, Blanca, Verde y Amarilla
    ...
    PokemonFB(978,"9",R.drawable.tatsugiri, "Tatsugiri","Pokémon dragón de pequeño tamaño. Vive en la boca de un Dondozo para protegerse de los ataques de los depredadores.",listOf(PokemonTipoFB.DRAGON,PokemonTipoFB.AGUA), listOf(978,978,978)), // Tatsugiri tiene 3 formas: Estriada, Gota y Rizada
    ...
    PokemonFB(980,"9",R.drawable.clodsire, "Clodsire","Vive en el fondo de los estanques y pantanos. Nada con Wooper sobre el lomo para ayudarlos a cruzar de una orilla a otra.",listOf(PokemonTipoFB.VENENO,PokemonTipoFB.TIERRA), listOf(194,980)),
    ...
    PokemonFB(983,"9",R.drawable.kingambit, "Kingambit","Solo el Bisharp más destacado entre las filas de cada gran ejército tiene el honor de evolucionar a Kingambit.",listOf(PokemonTipoFB.SINIESTRO,PokemonTipoFB.ACERO), listOf(625,983)),
    ...
    PokemonFB(999,"9",R.drawable.gimmighoul, "Gimmighoul","El cofre en el que nació data de hace 1500 años aproximadamente. Absorbe la energía vital de los granujas que intentan hacerse con su tesoro.",listOf(PokemonTipoFB.FANTASMA), listOf(999,1000,999)), // Gimmighoul tiene dos formas: Cofre y Andante
    ...
    PokemonFB(1011,"9",R.drawable.dipplin, "Dipplin","Ha evolucionado gracias a una manzana especial que solo se cultiva en cierta zona. Este Pokémon está formado por dos individuos.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON), listOf(842,1011)),
    ...
    PokemonFB(1018,"9",R.drawable.archaludon, "Archaludon","Acumula la electricidad estática de su entorno. El rayo que dispara cuando está a cuatro patas posee una potencia colosal.",listOf(PokemonTipoFB.ACERO,PokemonTipoFB.DRAGON), listOf(1018,785,1018)),
    PokemonFB(1019,"9",R.drawable.hydrapple, "Hydrapple","Se trata de siete seres llamados Viborappli que viven juntos en una manzana de caramelo. El del centro es el líder del grupo.",listOf(PokemonTipoFB.PLANTA,PokemonTipoFB.DRAGON), listOf(842,1019)),
    PokemonFB(1020,"9",R.drawable.flamariete, "Flamariete","Apenas constan avistamientos de este Pokémon, pero existe una breve grabación donde aparece desbocado y escupiendo ráfagas de fuego.",listOf(PokemonTipoFB.FUEGO,PokemonTipoFB.DRAGON), listOf(842,1020)),
    PokemonFB(1021,"9",R.drawable.electrofuria, "Electrofuria","Se dice que calcina todo cuanto lo rodea con los rayos que libera su pelaje. Aparte de eso, se sabe muy poco sobre esta criatura.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.DRAGON), listOf(842,1021)),
...
/*
    ...
    PokemonFB(1042,"8",R.drawable.galarmeowth,"Meowth de Galar", "Algunas partes de su cuerpo se volvieron metálicas tras una larga convivencia con aguerrida gente del mar.", listOf(PokemonTipoFB.ACERO),listOf(1042)),
    ...
    PokemonFB(1049,"8",R.drawable.galarmrmime,"Mr. Mime de Galar", "Emite un aire glacial por las plantas de los pies. Baila claqué con entusiasmo sobre las superficies que ha congelado.", listOf(PokemonTipoFB.HIELO, PokemonTipoFB.PSIQUICO),listOf(439,866,1049)),
    ...
    PokemonFB(1066,"8",R.drawable.hisuiqwilfish,"Qwilfish de Hisui", "Vive en las aguas cercanas a tierras frías. Sus púas tóxicas son más gruesas y cortas que las de los Qwilfish de otras regiones.", listOf(PokemonTipoFB.SINIESTRO, PokemonTipoFB.VENENO),listOf(1066)),
    PokemonFB(1067,"8",R.drawable.hisuisneasel,"Sneasel de Hisui", "Sus robustas garras son ideales para moverse por los riscos más escarpados. De sus puntas rezuma un veneno que daña los nervios de las presas que captura.", listOf(PokemonTipoFB.LUCHA, PokemonTipoFB.VENENO),listOf(1067,903)),
    ...
    PokemonFB(1080,"9",R.drawable.paldeawooper,"Wooper de Paldea", "Ante el riesgo que le supone desplazarse solo, forma filas de tres o cuatro individuos que cuidan unos de otros mientras recorren los pantanos.", listOf(PokemonTipoFB.VENENO, PokemonTipoFB.TIERRA),listOf(1080)),
