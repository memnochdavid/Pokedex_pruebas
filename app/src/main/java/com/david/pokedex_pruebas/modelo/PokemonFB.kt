...
var listaPokeFB : List<PokemonFB> = listOf(
    ...
    PokemonFB(478,"",R.drawable.froslass, "Lickilicky","Su larga lengua está siempre llena de babas. El contacto con su saliva causa entumecimiento.",listOf(PokemonTipoFB.HIELO,PokemonTipoFB.FANTASMA)),
    PokemonFB(479,"",R.drawable.rotom, "Lickilicky","Su larga lengua está siempre llena de babas. El contacto con su saliva causa entumecimiento.",listOf(PokemonTipoFB.ELECTRICO,PokemonTipoFB.FANTASMA)),
    PokemonFB(480,"",R.drawable.uxie, "Lickilicky","Su larga lengua está siempre llena de babas. El contacto con su saliva causa entumecimiento.",listOf(PokemonTipoFB.PSIQUICO)),
    PokemonFB(481,"",R.drawable.mesprit, "Lickilicky","Su larga lengua está siempre llena de babas. El contacto con su saliva causa entumecimiento.",listOf(PokemonTipoFB.PSIQUICO)),
